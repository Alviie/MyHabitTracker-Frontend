...
<template>
  <div>
    <!-- globaler Header mit Button, rechts oben -->
    <header class="flex justify-end mb-6">
      <button
        @click="toggleDarkMode"
        class="p-2 rounded-full bg-slate-200 text-slate-800 hover:bg-slate-300 transition-all
        ...
        <svg v-else class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
          <path
            ...
            d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4
               ...
               11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465
